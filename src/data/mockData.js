...
export const mentors = [
  ...
  },
  {
    id: 7,
    name: "د. خالد الشنفري",
    role: "خبير ريادة أعمال",
    focus: "ريادة الأعمال ونمو المشاريع - عُمان",
    icon: "Award",
    expertise: ["ريادة الأعمال", "نمو المشاريع", "التمويل المبكر"],
    unavailableDates: [
      "2025-11-09",
      "2025-11-18",
      "2025-11-24",
  ...
  },
  {
    ...
    name: "سالم الحبسي",
    role: "خبير تقني",
    focus: "الهندسة البرمجية والبنية السحابية - الخليج",
    icon: "Code",
    expertise: ["الهندسة البرمجية", "البنية السحابية", "قابلية التوسع"],
    unavailableDates: [
      "2025-11-08",
      "2025-11-19",
      "2025-11-25",
